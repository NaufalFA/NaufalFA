...
<div id="content">
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a href="cetak/cetak-buku.php?id=<?php echo $r_tampil_buku['dbuku]; ?>" 
					target="_blank" class="tombol">Cetak Buku</a></div>

				<div class="tombol-opsi-container"><a href="index.php?p=buku-edit&id=<?php echo $r_tampil_buku['idbuku'];?>" class="tombol">Edit</a></div>
				<div class="tombol-opsi-container"><a href="proses/anggota-hapus.php?id=<?php echo $r_tampil_anggota['idbuku']; ?>" class="tombol">Hapus</a></div>
			</td>
		</tr>
		<?php } ?>
	</table>
