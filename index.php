	...
	<div id="container">
		<div id="header">
			<div id="logo-perpustakaan-container">
				<image id="logo-perpustakaan" src="images/logo-perpus.png" border=0 style="border:0; text-decoration:none; outline:none"> 
			</div>
			<div id="nama-alamat-perpustakaan-container">
				...
				<div class="nama-alamat-perpustakaan">
					<h3>Jl. Lembah Abang No 11, Telp: (021)55555555</h3>
				</div>
			</div>
		</div>
		<div id="header2">
			<div id="nama-user">Selamat Datang,<?php echo$_SESSION['sesi']; ?>!</div>
		</div>
		<div id="sidebar">
			<a href="index.php?p=beranda">Beranda</a>
			<p class="label-navigasi">Data Utama</p>
			<ul>
